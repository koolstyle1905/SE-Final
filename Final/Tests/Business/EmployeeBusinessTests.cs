...
namespace Tests.Business
{
	...
	public class EmployeeBusinessTests
	{
		...
		{
			mockContext.Setup(m => m.Employees).Returns(new FakeEmployeeRepository(testData);
		...
		public void GetEmployeeTest(List<Employee> testData)
		{
			...
			mockContext.Setup(m => m.Employees).Returns(new FakeRepository<Employee>(testData));
